  ...
  */
  ...
  private void getValues(boolean array) throws Exception {
    ...
    for (int i = 0; i < mx && p < bb.length; ++i) {
      ...
      if (array) pojo.add(ob);
      else {
        tFields.replace(n, nName);
        vFields.put(n, ob);
      }
    }
  }
